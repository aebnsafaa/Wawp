...
class AWP_Mainset {
    ...
    public function enqueue_admin_assets() {
        ...
        if ('admin.php' === $pagenow && isset($_GET['page']) && 'awp-settings' === $_GET['page']) {
            wp_enqueue_style('bootstrap-css', plugins_url('assets/css/resources/bootstrap.min.css', __FILE__), [], '5.2.3');
            wp_enqueue_script('bootstrap-js', plugins_url('assets/js/resources/bootstrap.min.js', __FILE__), ['jquery'], null, true);
    
            if (is_rtl()) {
                wp_enqueue_style('awp-admin-rtl-css', plugins_url('assets/css/awp-admin-rtl-style.css', __FILE__), [], '1.1.4');
            }
            wp_enqueue_style('admin', plugins_url('assets/css/awp-admin-style.css', __FILE__), [], '1.0.0');
            wp_enqueue_script('awp-admin-js', plugins_url('assets/js/awp-admin-set.js', __FILE__), ['jquery', 'bootstrap-js'], '1.1.4', true);
            ...
            <div class="form-wrapper">
                ...
                <div class="awp-settings-card">
                    ...
                    <div class="instance-control" data-instance-id="<?php echo esc_attr($instances['instance_id']); ?>" data-access-token="<?php echo esc_attr($instances['access_token']); ?>">
                        <hr class="divi">
                        <div class="btn-box">
                            <a href="#" class="button ins-action" data-action="status"><?php esc_html_e('Connection status', 'awp'); ?></a>
                        ...
                        <div class="toggles">
                            <div class="awp-field">
                                <div class="form-check form-switch d-flex align-items-center">
                                    <input class="form-check-input awp-toggle-switch" type="checkbox" role="switch" name="wwo_settings[general][active_login]" id="login_active" <?php echo (isset($settings['general']['active_login']) && $settings['general']['active_login'] == 'on') ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="login_active"><?php esc_html_e('Enable OTP login', 'awp'); ?></label>
                                </div>
                            </div>
                            <div class="awp-field">
                                <div class="form-check form-switch d-flex align-items-center">
                                    <input class="form-check-input awp-toggle-switch" type="checkbox" role="switch" name="wwo_settings[general][active_register]" id="active_register" <?php echo (isset($settings['general']['active_register']) && $settings['general']['active_register'] == 'on') ? 'checked' : ''; ?>>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><?php esc_html_e('Wawp testing', 'awp'); ?></h5>
                            <img src="<?php echo plugins_url('/assets/img/wawp-Logox2.png', __FILE__); ?>" alt="Wawp Logo" class="wawp-logo" style="height: 24px; margin: 0 8px;">
                        </div>
    ...
    public function register_settings() {
        ...
        add_settings_field(
            ...
            [$this, 'activate_register_callback'],
            'awp-settings-access',
            'awp_access_settings_section'
        );
        ...
        add_settings_field(
            ...
            'Instance ID',
            [$this, 'instance_id_notifications_callback'],
            'awp-settings-notifications',
            'awp_notifications_settings_section'
        );
        ...
        add_settings_field(
            ...
            'Access Token',
            [$this, 'access_token_notifications_callback'],
            'awp-settings-notifications',
            'awp_notifications_settings_section'
        );
    }
