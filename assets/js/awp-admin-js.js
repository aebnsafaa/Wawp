...
$(document).ready(function() {
    initializePlaceholderDropdown('.placeholder-container', placeholders, 'Add personalization');
    initializePlaceholderDropdown('.placeholder-containerab', placeholdersabcart, 'Add personalization');
    initializePlaceholderDropdown('.placeholder-messageTemplatesar', messageTemplatesAr, 'القوالب الجاهزة للإستخدام');
     initializePlaceholderDropdown('.placeholder-container-ar', placeholdersAr, 'خصص رسائل الإشعارات');
...
if ($("#admin_number").length) {
    ...
    $('.table-message-logs').on("click", '.log-resend', function (e) {
        e.preventDefault();
        $('input[name=awp_resend_phone]').val($(this).parents('tr').find('.log-phone').text());
        $('input[name=awp_resend_message]').val($(this).parents('tr').find('.log-msg div').text());
        $('input[name=awp_resend_image]').val($(this).parents('tr').find('.log-img').text());
        $('input[name=awp_resend_wa]').click();
    });
