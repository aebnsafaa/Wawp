						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td class="<?php echo esc_attr( $this->awp_status_class( $system_info['php_memory_limit'], '1024M' ) ); ?>"><span class="<?php echo esc_attr( $this->awp_status_icon( $system_info['php_memory_limit'], '1024M' ) ); ?>"></span> <?php echo esc_html( $system_info['php_memory_limit'] ); ?></td>
								</tr>
								<tr>
